...
CREATE TYPE "public"."role" AS ENUM('super_admin', 'admin', 'support', 'seller', 'customer');--> statement-breakpoint
...
ALTER TABLE "products" ADD COLUMN "images" jsonb DEFAULT '[]';--> statement-breakpoint
